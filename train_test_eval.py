...
if __name__ == "__main__":
    ...
    parser.add_argument('--init_method', default='tcp://127.0.0.1:33119', type=str, help='init_method')
    ...
    parser.add_argument('--pretrained_model', default='./pretrained_model/82.6_T2T_ViTt_24.pth.tar', type=str, help='load Pretrained model')
    ...
    # parser.add_argument('--test_paths', type=str, default='PASCAL-S')

    # evaluation
    parser.add_argument('--Evaluation', default=False, type=bool, help='Evaluation or not')
    parser.add_argument('--methods', type=str, default='ERNet', help='evaluated method name')
